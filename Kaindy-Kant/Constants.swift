...
struct Constants {
    ...
    struct Weather {
        ...
        init () {
            ...
            Weather.weatherStatuses = ["Partly cloudy": "Частично облачно", "Mostly sunny": "Преимущественно солнечно","Intermittent clouds": "Переменная облачность", "Mostly cloudy": "Преимущественно облачно", "Cloudy" : "cloudy".localized(lang: lang!)!, "Clear" : "sunny".localized(lang: lang!)!, "Rain" : "rainy".localized(lang: lang!)!, "Snow" : "snowy".localized(lang: lang!)!]
